...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2025 at 06:50 PM
...
(12, 'ljlajf', '', 'Garcia', 'Male', NULL, NULL, '2025-09-19 14:35:17');
...
(33, 3, 3, 1, 2, 1, 39.00, 9.00, 30.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.00, 84.38, 90.00, 98.00, 39.00, 12.00, 60.00, 21.00, 98.00, 24.38),
(34, 1, 1, 1, 2, 1, 19.00, 7.00, 12.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 40.00, 79.00, 86.00, 48.00, 19.00, 20.00, 100.00, 35.00, 100.00, 25.00),
(83, 14, 3, 1, 2, 1, 38.00, 9.00, 29.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.00, 96.00, 97.00, 95.00, 23.75, 19.00, 95.00, 33.25, 98.00, 39.00),
(84, 13, 3, 1, 2, 1, 38.00, 9.00, 29.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.00, 95.75, 97.00, 95.00, 19.00, 19.00, 95.00, 47.50, 98.00, 29.25),
(85, 14, 18, 1, 2, 1, 17.00, 8.00, 9.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 40.00, 88.50, 92.00, 43.00, 8.50, 20.00, 100.00, 50.00, 100.00, 30.00),
(92, 3, 6, 1, 3, 1, 68.00, 40.00, 28.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 28.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 40.00, 95.43, 97.00, 97.00, 19.43, 28.00, 93.00, 56.00, 100.00, 20.00),
(93, 1, 6, 1, 3, 1, 68.00, 40.00, 28.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 30.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 40.00, 99.43, 99.00, 97.00, 19.43, 30.00, 100.00, 60.00, 100.00, 20.00);
...
CREATE TABLE `grading_components` (
  ...
  `subject_id` int(11) NOT NULL,
  `teacher_id` int(11) NOT NULL,
  `ww_percent` int(11) NOT NULL,
  `pt_percent` int(11) NOT NULL,
  `qa_percent` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Kedlau', 'New', 'York', 'Male', 1, 4, '2025-09-04 17:27:36', '2025-09-05 13:00:42'),
(3, 'allen iverson', 'ednalan', 'bravo', 'Female', 1, 4, '2025-09-04 17:27:36', '2025-09-19 22:36:15'),
...
(9, 'Shuten', 'Miskei', 'Durtsch', 'Female', 5, 18, '2025-09-04 17:27:36', '2025-09-19 22:36:04'),
(13, 'King', 'Ponern', 'Imazuwa', 'Male', 3, 10, '2025-09-17 11:41:18', '2025-09-19 00:11:33'),
(14, 'Shuna', 'Law', 'Unenern', 'Female', 3, 10, '2025-09-17 14:47:27', '2025-09-17 14:47:27');
...
INSERT INTO `teachers` (`id`, `fname`, `mname`, `lname`, `email`, `created_at`) VALUES
(1, 'Juan', 'Cruz', 'Dela Cruz', 'kramsetlab99@gmail.com', '2025-08-21 06:23:03'),
(2, 'Maria', 'Luna', 'Santos', 'maria.santos@example.com', '2025-08-21 06:23:03'),
(3, 'Jose', 'Reyes', 'Tan', 'jose.tan@example.com', '2025-08-21 06:23:03'),
(4, 'Ana', 'Lopez', 'Garcia', 'ana.garcia@example.com', '2025-08-21 06:23:03'),
(5, 'Pedro', 'M.', 'Ramos', 'pedro.ramos@example.com', '2025-08-21 06:23:03'),
(6, 'Diamond', 'santa', 'six', 'diamondsantasiz@gmail.com', '2025-08-23 15:26:01');
...
(1, 'admin1', '$2y$10$xV8eZsIbojFtsAMrI0.hwe.H8mhcUDve.H8Qctr4SRxaHGxXvgHeq', 1, 1, 0),
(2, 'adviser1', '$2y$10$0Lt.20KjkFkQbehCrfynGeITk9OfR0u9PLClKe8LoAPRloc5S56uK', 2, 2, 0),
(3, 'teacher1', '$2y$10$0SW36NMwc0xs6HLRaAE8Rupd9IDocaRq6P7XP9yZwehrCveY/25Da', 3, 3, 0),
...
ALTER TABLE `grades`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_student_subject_year_quarter` (`student_id`,`subject_id`,`academic_year_id`,`quarter_id`),
  ADD KEY `subject_id` (`subject_id`),
  ADD KEY `academic_year_id` (`academic_year_id`),
  ADD KEY `quarter_id` (`quarter_id`),
...
ALTER TABLE `grading_components`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_component` (`academic_year_id`,`quarter_id`,`section_id`,`subject_id`,`teacher_id`),
  ADD KEY `fk_gc_quarter` (`quarter_id`),
  ADD KEY `fk_gc_section` (`section_id`),
...
--
ALTER TABLE `grades`
  ADD CONSTRAINT `fk_grades_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`),
...
--
ALTER TABLE `grading_components`
  ADD CONSTRAINT `fk_gc_acad` FOREIGN KEY (`academic_year_id`) REFERENCES `academic_years` (`id`),
  ADD CONSTRAINT `fk_gc_quarter` FOREIGN KEY (`quarter_id`) REFERENCES `quarters` (`id`),
  ADD CONSTRAINT `fk_gc_section` FOREIGN KEY (`section_id`) REFERENCES `sections` (`id`),
  ADD CONSTRAINT `fk_gc_subject` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`id`);
