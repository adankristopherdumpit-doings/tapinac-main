...
<div class="d-flex flex-column flex-shrink-0 text-white bg-green sidebar">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <!-- Report Dropdown -->
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle text-white <?= ($currentPage == 'report.php') ? 'active' : '' ?>"
         href="#"
         role="button"
         data-bs-toggle="dropdown"
         data-bs-auto-close="outside"
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item <?= ($_GET['quarter'] ?? '') == 1 ? 'active' : '' ?>" href="student_report.php?quarter=1">First Quarter</a></li>
        <li><a class="dropdown-item <?= ($_GET['quarter'] ?? '') == 2 ? 'active' : '' ?>" href="report.php?quarter=2">Second Quarter</a></li>
        <li><a class="dropdown-item <?= ($_GET['quarter'] ?? '') == 3 ? 'active' : '' ?>" href="report.php?quarter=3">Third Quarter</a></li>
        <li><a class="dropdown-item <?= ($_GET['quarter'] ?? '') == 4 ? 'active' : '' ?>" href="report.php?quarter=4">Fourth Quarter</a></li>
      </ul>
    </li>
    ...
    <!-- Certificate -->
    <li>
      <a href="student_certificate.php" class="nav-link text-white <?= ($currentPage == 'student_certificate.php') ? 'active' : '' ?>">
