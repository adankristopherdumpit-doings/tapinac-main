...
<!-- Sidebar (Visible on medium and up) -->
<div class="d-none d-md-flex flex-column flex-shrink-0 p-3 text-white sidebar"
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="admin_manage_user.php" class="nav-link text-white <?= ($currentPage == 'admin_manage_user.php') ? 'active' : '' ?>">
        <i class="bi bi-person-vcard me-2"></i> Account Management
      </a>
    </li>
    <li>
